...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    //memberikan deklarasi untuk main
    ListView listView;
    DBHelper helper;
    LayoutInflater inflater;
    View dialogView;
    TextView Tv_Nomor, Tv_Nama, Tv_TempatLahir, Tv_JK, Tv_Tanggal, Tv_Alamat;
    //membuat aksi dari layout activity_main.xml
    @Override
    ...
    //koneksikan dengan helper dan listview
        helper = new DBHelper(this);
        listView = (ListView)findViewById(R.id.list_data);
        listView.setOnItemClickListener(this);
    }
    //memberikan inflate opsi menu
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        //opsi menu ini menambahkan item ke bilah tindakan jika ada.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        //Menangani item bilah tindakan klik di sini. Bilah tindakan akan
        //otomatis menangani klik pada tombol Beranda/Atas, begitu lama
        //saat Anda menentukan aktivitas induk di AndroidManifest.xml.
    ...
    //tampilkan listview cursor bisa klik all data bisa dilihat
