...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    int images[];
    Context context;
    //mengkonekkan variable diatas dengan variable yang sudah berhasil dibuat dari MainActivity.java
    ...
    //untuk menyesuaikan posisi letak gambar menggunakan onBindViewHolder
    @Override
    ...
    //letakkan hitungan/count atau panjang/length image yang ada dalam array
    @Override
    public int getItemCount() {
        return images.length;
    }
    //MyViewHolder memanggil data dari RecyclerView.viewholder
